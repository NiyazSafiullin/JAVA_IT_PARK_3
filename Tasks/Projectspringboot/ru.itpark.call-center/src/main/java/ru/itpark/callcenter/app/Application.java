package ru.itpark.callcenter.app;
...
@ComponentScan(basePackages = "ru.itpark.callcenter")
// говорим, где лежат классы, которые будут
// объектом взаимодействия с бд
@EntityScan(basePackages = "ru.itpark.callcenter.models")
// говорим, что наши репозитории описаны в данном пакете
// Spring JPA сам сгенерирует для них реализацию
@EnableJpaRepositories(basePackages = "ru.itpark.callcenter.repositories")
